...
function triggerRef(ref) {
    trigger$1(ref, "set" /* SET */, 'value', ref.value );
}
function unref(ref) {
    ...
    constructor(getter, _setter, isReadonly) {
        ...
        this.effect = effect(getter, {
            ...
            scheduler: () => {
                if (!this._dirty) {
                    this._dirty = true;
                    trigger$1(toRaw$1(this), "set" /* SET */, 'value');
                }
            }
        });
...
function applyOptions(instance, options, deferredData = [], deferredWatch = [], asMixin = false) {
    ...
    if (!asMixin) {
        ...
        {
            const rawData = toRaw$1(instance.data);
